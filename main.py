...
plt.tight_layout()
path = os.path.join('./images produced', 'Decision Tree.png')
plt.savefig(path)
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Blues', xticklabels=['No Back Pain', 'Back Pain'],
            yticklabels=['No Back Pain', 'Back Pain'])
plt.xlabel('Predicted Label')
plt.ylabel('True Label')
plt.title('Confusion Matrix')
path = os.path.join('./images produced', 'confusion matrix.jpeg')
plt.savefig(path)
